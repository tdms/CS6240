	...
	private void initGUI() {
		try {
			...
			thisLayout.setVerticalGroup(thisLayout.createSequentialGroup()
				...
				.addGroup(thisLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
				    .addComponent(notificationList, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
				    .addComponent(jLabel3, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE))
				...
				.addGroup(thisLayout.createParallelGroup()
				    ...
				    .addGroup(thisLayout.createSequentialGroup()
				        ...
				        .addGroup(thisLayout.createParallelGroup()
				            ...
				            .addComponent(addNewsButton, GroupLayout.Alignment.LEADING, 0, 270, Short.MAX_VALUE)
				            .addGroup(thisLayout.createSequentialGroup()
				                .addPreferredGap(jLabel2, jLabel4, LayoutStyle.ComponentPlacement.INDENT)
				                .addGroup(thisLayout.createParallelGroup()
				                    .addComponent(jLabel4, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 69, GroupLayout.PREFERRED_SIZE)
				                    .addComponent(jLabel5, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 69, GroupLayout.PREFERRED_SIZE))
				                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
				                .addGroup(thisLayout.createParallelGroup()
				                    .addComponent(keywordTextField, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 155, GroupLayout.PREFERRED_SIZE)
				                    .addComponent(eventTypeList, GroupLayout.Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 155, GroupLayout.PREFERRED_SIZE)
				                    .addGroup(thisLayout.createSequentialGroup()
				                        .addComponent(notificationList, GroupLayout.PREFERRED_SIZE, 155, GroupLayout.PREFERRED_SIZE)
				                        .addGap(0, 0, Short.MAX_VALUE))
				                    .addGroup(thisLayout.createSequentialGroup()
