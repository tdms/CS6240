		...
		try {
			...
			thisLayout.setVerticalGroup(thisLayout.createSequentialGroup()
				...
				.addGroup(thisLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
				    .addComponent(userEmailTextField, GroupLayout.Alignment.BASELINE, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				...
				.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
				.addGroup(thisLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
				    .addComponent(notEmailTextField, GroupLayout.Alignment.BASELINE, GroupLayout.PREFERRED_SIZE, 21, GroupLayout.PREFERRED_SIZE)
			...
			thisLayout.setHorizontalGroup(thisLayout.createSequentialGroup()
				...
				.addGroup(thisLayout.createParallelGroup()
				    ...
				    .addGroup(thisLayout.createSequentialGroup()
				        .addGroup(thisLayout.createParallelGroup()
				            .addComponent(jLabel3, GroupLayout.Alignment.LEADING, 0, 161, Short.MAX_VALUE)
				            .addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
				            ...
				            .addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
				                .addComponent(jLabel2, 0, 155, Short.MAX_VALUE)
				                .addGap(6))
				            .addGroup(GroupLayout.Alignment.LEADING, thisLayout.createSequentialGroup()
